...
const Profile = () => {
    ...
    return ( <
        ...
        div class = "status" >
        <
        i class = "fa fa-circle offline" > < /i> offline since March 12 < /
        div > <
        /div> < /
        li >
        ...
        <
        /div> <
        button class = "toggle-others"
        id = "btnOthers" > < span > chats < /span></button >
        <
        /aside> <
        ...
        span class = "time-right" > 11 : 02 AM < /span> < /
        div >
        ...
        <
        p > Nah, not yet. < /p> <
        span class = "time-left" > 11: 05 AM < /span> < /
        div > <
        div class = "container" >
        <
        img src = { bhawan }
